...
class MyCupertinoControls extends StatefulWidget {
  final Function fullScreenFunction;
  const MyCupertinoControls({
...
class _CupertinoControlsState extends State<MyCupertinoControls> {
...
//    final uint8list = await _flutterVideoCompress.getThumbnail(url,
//        quality: 50, // default(100)
//        position: -1 // default(-1)
//    );
//    final img = MemoryImage(uint8list);
//    setState(() {
//      this.provider = img; // AssetImage('assets/images/phone.png');
//    });
  }
            ...
            child: Stack(
              children: <Widget>[
                Positioned(
                  ...
                  child: playThumbnialShape(),
                ),
                Center(
                  child: AnimatedOpacity(
                    opacity: _hideStuff ? (!_latestValue.isPlaying?1.0:0.0) : 1.0,
                    duration: Duration(milliseconds: 300),
                    child: CupertinoButton(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Icon(chewieController.videoPlayerController.value.isPlaying?Icons.pause:Icons.play_arrow, size: 32.0,color: Color(0XFFFFFFFF),),
                        ),
                      ),
                    ),
                  ),
